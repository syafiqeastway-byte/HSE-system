              ...
              <table className="w-full border-collapse border border-slate-300 dark:border-zinc-700 text-left text-[9px] sm:text-[10px] sm:text-xs whitespace-nowrap">
                <thead className="bg-slate-100 dark:bg-zinc-800/80 text-slate-800 dark:text-zinc-100">
                  <tr className="border-b border-slate-300 dark:border-zinc-700">
                    <th className="py-1.5 px-2 sm:py-3 sm:px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[9px] sm:text-[9px] sm:text-[10px] tracking-wider whitespace-nowrap text-center">NO</th>
                    <th className="py-1.5 px-2 sm:py-3 sm:px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[9px] sm:text-[9px] sm:text-[10px] tracking-wider whitespace-nowrap text-center">DATE</th>
                    <th className="py-1.5 px-2 sm:py-3 sm:px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[9px] sm:text-[9px] sm:text-[10px] tracking-wider whitespace-nowrap text-center">YEAR</th>
                    <th className="py-1.5 px-2 sm:py-3 sm:px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[9px] sm:text-[9px] sm:text-[10px] tracking-wider min-w-[120px]">LOCATION</th>
                    <th className="py-1.5 px-2 sm:py-3 sm:px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[9px] sm:text-[9px] sm:text-[10px] tracking-wider min-w-[200px]">DESCRIPTION</th>
                    <th className="py-1.5 px-2 sm:py-3 sm:px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[9px] sm:text-[9px] sm:text-[10px] tracking-wider whitespace-nowrap text-center">OCCUPATIONAL INCIDENT?</th>
                    <th className="py-1.5 px-2 sm:py-3 sm:px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[9px] sm:text-[9px] sm:text-[10px] tracking-wider min-w-[140px]">INCIDENT CATEGORY</th>
                    <th className="py-1.5 px-2 sm:py-3 sm:px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[9px] sm:text-[9px] sm:text-[10px] tracking-wider whitespace-nowrap text-center">PROPERTY DAMAGE</th>
                    <th className="py-1.5 px-2 sm:py-3 sm:px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[9px] sm:text-[9px] sm:text-[10px] tracking-wider whitespace-nowrap">DAMAGE LEVEL</th>
                    <th className="py-1.5 px-2 sm:py-3 sm:px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[9px] sm:text-[9px] sm:text-[10px] tracking-wider min-w-[140px]">CLASSIFICATION</th>
                    <th className="py-1.5 px-2 sm:py-3 sm:px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[9px] sm:text-[9px] sm:text-[10px] tracking-wider min-w-[120px]">INJURY TYPE</th>
                    <th className="py-1.5 px-2 sm:py-3 sm:px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[9px] sm:text-[9px] sm:text-[10px] tracking-wider min-w-[120px]">PERSON INVOLVE</th>
                    <th className="py-1.5 px-2 sm:py-3 sm:px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[9px] sm:text-[9px] sm:text-[10px] tracking-wider whitespace-nowrap">WORK EXPERIENCE</th>
                    <th className="py-1.5 px-2 sm:py-3 sm:px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[9px] sm:text-[9px] sm:text-[10px] tracking-wider min-w-[110px]">REPORTED BY</th>
                    <th className="py-1.5 px-2 sm:py-3 sm:px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[9px] sm:text-[9px] sm:text-[10px] tracking-wider text-center whitespace-nowrap">PDF</th>
                  </tr>
                </thead>
                  ...
                  {filteredIncidents.map((inc) => {
                    ...
                    return (
                      ...
                      <td className="py-1.5 px-2 sm:py-3 sm:px-3 text-center whitespace-nowrap border border-slate-300 dark:border-zinc-700">
                        <span className={`px-2 py-0.5 rounded text-[9px] sm:text-[9px] sm:text-[10px] font-bold uppercase ${
