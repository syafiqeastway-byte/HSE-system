              ...
              <table className="w-full border-collapse border border-slate-300 dark:border-zinc-700 text-left text-xs whitespace-nowrap">
                <thead className="bg-slate-100 dark:bg-zinc-800/80 text-slate-800 dark:text-zinc-100">
                  <tr className="border-b border-slate-300 dark:border-zinc-700">
                    <th className="py-3 px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[10px] tracking-wider whitespace-nowrap text-center">NO</th>
                    <th className="py-3 px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[10px] tracking-wider whitespace-nowrap text-center">DATE</th>
                    <th className="py-3 px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[10px] tracking-wider whitespace-nowrap text-center">YEAR</th>
                    <th className="py-3 px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[10px] tracking-wider min-w-[120px]">LOCATION</th>
                    <th className="py-3 px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[10px] tracking-wider min-w-[200px]">DESCRIPTION</th>
                    <th className="py-3 px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[10px] tracking-wider whitespace-nowrap text-center">OCCUPATIONAL INCIDENT?</th>
                    <th className="py-3 px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[10px] tracking-wider min-w-[140px]">INCIDENT CATEGORY</th>
                    <th className="py-3 px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[10px] tracking-wider whitespace-nowrap text-center">PROPERTY DAMAGE</th>
                    <th className="py-3 px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[10px] tracking-wider whitespace-nowrap">DAMAGE LEVEL</th>
                    <th className="py-3 px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[10px] tracking-wider min-w-[140px]">CLASSIFICATION</th>
                    <th className="py-3 px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[10px] tracking-wider min-w-[120px]">INJURY TYPE</th>
                    <th className="py-3 px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[10px] tracking-wider min-w-[120px]">PERSON INVOLVE</th>
                    <th className="py-3 px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[10px] tracking-wider whitespace-nowrap">WORK EXPERIENCE</th>
                    <th className="py-3 px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[10px] tracking-wider min-w-[110px]">REPORTED BY</th>
                    <th className="py-3 px-3 border border-slate-300 dark:border-zinc-700 font-extrabold text-[10px] tracking-wider text-center whitespace-nowrap">PDF</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-200 dark:divide-slate-800/60 bg-white dark:bg-transparent text-slate-700 dark:text-slate-300">
                  {filteredIncidents.map((inc) => {
                    ...
                    return (
                      ...
                      {/* 5. DESCRIPTION */}
                      <td className="py-3 px-3 text-slate-600 dark:text-slate-400 min-w-[200px] border border-slate-300 dark:border-zinc-700" title={(inc as any).rootCause || inc.description || (inc as any).root_cause || ''}>
