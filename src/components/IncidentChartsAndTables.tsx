        ...
        <div>
          ...
          <div className="overflow-x-auto rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
            <table className="w-full text-left border-collapse text-xs">
              <thead>
                <tr className="bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-400 font-bold uppercase text-[10px] tracking-wider border-b border-slate-200 dark:border-slate-800">
                ...
                {displayIncidents.length === 0 ? (
                  ...
                  displayIncidents.map((inc) => (
                    <tr key={inc.id} className="hover:bg-slate-100 dark:hover:bg-slate-800/80 active:bg-slate-200 dark:active:bg-slate-700/60 transition-colors cursor-pointer">
                      ...
                      {/* 5. DESCRIPTION */}
                      <td className="py-3 px-3 text-slate-600 dark:text-slate-400 min-w-[200px]" title={inc.description}>
