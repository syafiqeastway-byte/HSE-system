          ...
          {loading ? (
            ...
            <div className="overflow-x-auto sm:rounded-xl border-y sm:border border-slate-200 dark:border-slate-800">
              <table className="w-full text-left border-collapse text-xs">
                <thead>
                  <tr className="bg-slate-50 dark:bg-slate-900/90 text-slate-600 dark:text-slate-400 font-bold uppercase text-[10px] tracking-wider border-b border-slate-200 dark:border-slate-800">
                ...
                <tbody className="divide-y divide-slate-200 dark:divide-slate-800/60 bg-white dark:bg-transparent text-slate-700 dark:text-slate-300">
                  {filteredIncidents.map((inc) => (
                    <tr key={inc.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                      ...
                      {/* 2. DATE */}
                      <td className="py-3 px-3 font-mono whitespace-nowrap text-slate-500 dark:text-slate-400">
                        {inc.date}
                      </td>
                      {/* 3. YEAR */}
                      <td className="py-3 px-3 font-mono whitespace-nowrap text-slate-500 dark:text-slate-400">
                      ...
                      {/* 4. LOCATION */}
                      <td className="py-3 px-3 font-bold text-slate-900 dark:text-slate-200 whitespace-nowrap">
                        {inc.location}
                      </td>
                      {/* 5. DESCRIPTION */}
                      <td className="py-3 px-3 text-slate-600 dark:text-slate-400 min-w-[200px]" title={(inc as any).rootCause || inc.description || (inc as any).root_cause || ''}>
                      ...
                      {/* 8. PROPERTY DAMAGE */}
                      <td className="py-3 px-3 text-center whitespace-nowrap font-medium">
                        {inc.propertyDamage || '-'}
                      </td>
                      {/* 9. DAMAGE LEVEL */}
                      <td className="py-3 px-3 whitespace-nowrap font-medium text-slate-600 dark:text-slate-400">
                        {inc.damageLevel || '-'}
                      </td>
                      {/* 10. CLASSIFICATION */}
                      <td className="py-3 px-3 font-medium text-slate-800 dark:text-slate-300 whitespace-nowrap">
                        {inc.classification || '-'}
                      </td>
                      {/* 11. INJURY TYPE */}
